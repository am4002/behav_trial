...
"""
    ...
    CHANGED:
        duration is now set in trial_frame, where test() is called as a final arugment
"""
...
def betweenInterleaved (fi, nback_no, window, seq, dura, trial_no=None, adaptive=False):
...
def vDistractor (fi, nback_no, window,  seq, dura, trial_no=None, adaptive=False):
...
def aDistractor (fi, nback_no, window,  seq, dura, trial_no=None, adaptive=False):
...
def withinInterleaved (fi, nback_no, window, seq, dura, trial_no=None, adaptive=False):
