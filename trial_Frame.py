...
from nback_tests import vNback, aNback, withinInterleaved, betweenInterleaved, nPaired, nUnpaired, vDistractor, aDistractor
...
if __name__ == '__main__':
    ...
    for test in funcLis:
        tSq = seqGen(30,0.25) #here is where we specify how long the test sequence is going to be, and what % correct is desired
